...
from predictor.model.predictor_model import PublisherDAO, PublicationDAO, PublicationtextDAO, BinaryfileDAO, LanguageDAO, PublicationUnassignedV, PublicationAssignedV
